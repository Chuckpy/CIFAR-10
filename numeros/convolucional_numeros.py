...
plt.imshow(X_treinamento[85], cmap ="gray" )
plt.title('Classe' + str(y_treinamento[85]))
...
#etapa de convolução, pooling e flattening feitas

#rede neural densa inicio
...
plt.imshow(X_teste[6], cmap = 'gray')
plt.title('Classe ' + str(y_teste[6]))
...
imagem_teste = X_teste[6].reshape(1, 28, 28, 1)
